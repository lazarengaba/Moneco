package com.app.moneco.application.setting.screens
...
@Composable
fun SettingScreenView(navController: NavHostController) {
    MonecoTheme {
        Scaffold(
            bottomBar = {
                Column {
...
fun SettingScreenViewPreview() {
    SettingScreenView(navController = rememberNavController())
}